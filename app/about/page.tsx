    ...
    const schedule: dateItem[] = [
        {
            ...
            items: [
                ...
                { time: "8:35 AM", title: "Welcome, overview, and introduction of Governor Rhoden" },
                { time: "8:40 AM", title: "SD Governor Proclamation w/ opening ceremony & 250th Celebration" },
                { time: "9:00 AM", title: "From Strategy to Action: The SDNG Adjutant General on Infrastructure Resilience" },
